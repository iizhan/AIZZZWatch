export default {
  ...
  nav: {
    ...
    publicPricing: '公示榜',
    recommendations: '揭榜悬赏',
    recommendationsReview: '揭榜悬赏审核',
    beta: '试用',
    profile: '个人资料',
    users: '用户管理',
    groups: '分组管理',
    watch: 'Watch 监控',
    intelligentOperations: '智能运营',
    operationsOverview: '运营概览',
    upstreamSources: '上游站点',
    aggregatedPricing: '聚合排价',
    accountMappings: '账号关联',
    costProfit: '成本收益',
    autoPricing: '自动调价',
    priceChanges: '价格变动',
    keepaliveCenter: '保活中心',
    integrationDiagnostics: '接入诊断',
    channels: '渠道管理',
