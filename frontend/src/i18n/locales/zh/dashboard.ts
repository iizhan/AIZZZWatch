export default {
  ...
  usage: {
    ...
    failover: {
      ...
      pending: '故障转移 · 待核算',
      viewDetails: '查看故障转移与计费详情',
      detailTitle: '故障转移与计费详情',
      ...
      billingState: '计费状态',
      estimatedCost: '估算费用',
      usageHint: '502、524 和已配置的 5xx 失败尝试按本地估算输入 Token 结算，输出 Token 按 0 估算；最终成功请求仍按真实 usage 正常计费。',
      states: { started: '处理中', failed: '失败', succeeded: '成功', canceled: '已取消' },
      billing: {
        not_billable: '不计费', standard_usage: '随标准用量结算',
        pending_reconciliation: '待核算', reserved: '已预留', settled: '已结算', released: '已释放',
      },
    },
