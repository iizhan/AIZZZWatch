export default {
  ...
  usage: {
    ...
    failover: {
      switched: '故障转移 {count} 次',
      pending: '故障转移 · 待核算',
      viewDetails: '查看故障转移与扣费审计',
      detailTitle: '故障转移与扣费审计',
      requestSummary: '请求处理结果',
      attempt: '尝试',
      state: '结果',
      duration: '耗时',
      estimatedInputTokens: '估算输入 Token',
      billingState: '计费状态',
      estimatedCost: '失败尝试扣费',
      usageHint: '所有失败尝试均不扣用户余额或任何额度；Token 仅用于观测。只有最终成功请求按真实 usage 正常计费。历史“异常结算”记录需由管理员对账后独立冲正。',
      states: { started: '处理中', failed: '失败', succeeded: '成功', canceled: '已取消' },
      billing: {
        not_billable: '不计费', standard_usage: '随标准用量结算',
        pending_reconciliation: '历史待核算', reserved: '历史预留', settled: '历史异常结算（待冲正）', released: '历史已释放',
      },
    },
