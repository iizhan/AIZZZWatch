export default {
    ...
    users: {
      ...
      rechargeBonus: '赠送金额',
      rechargeBonusHint: '赠送余额会计入到账金额，但不计入累计充值和邀请返利',
      rechargePrincipalInvalid: '充值本金必须大于 0',
      rechargeBonusInvalid: '赠送金额不能小于 0',
      rechargeBonusOperationInvalid: '赠送金额仅支持充值操作',
      rechargeIdempotencyConflict: '该充值请求已用于其他金额，请关闭弹窗后重新操作',
      creditedTotal: '到账合计',
      withdrawAmount: '退款金额',
      withdrawAll: '全部',
