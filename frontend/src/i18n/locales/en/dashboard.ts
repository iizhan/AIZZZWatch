export default {
  ...
  usage: {
    ...
    failover: {
      ...
      viewDetails: 'View failover and billing details',
      detailTitle: 'Failover and Billing Details',
      ...
      usageHint: 'Failed attempts with 502, 524, or configured 5xx responses are settled from locally estimated input tokens with output tokens estimated as zero. The final successful request is still billed from actual usage.',
      ...
      billing: {
        ...
        pending_reconciliation: 'Pending reconciliation', reserved: 'Reserved', settled: 'Settled', released: 'Released',
      },
    },
