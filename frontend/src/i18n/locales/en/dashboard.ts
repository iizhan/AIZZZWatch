export default {
  ...
  usage: {
    ...
    failover: {
      switched: 'Failed over {count} time(s)',
      pending: 'Failover · pending reconciliation',
      viewDetails: 'View failover charge audit',
      detailTitle: 'Failover Charge Audit',
      requestSummary: 'Request result',
      attempt: 'Attempt',
      state: 'Result',
      duration: 'Duration',
      estimatedInputTokens: 'Estimated input tokens',
      billingState: 'Billing status',
      estimatedCost: 'Failed-attempt charge',
      usageHint: 'Failed attempts never deduct user balance or quotas; token counts are observational estimates only. Only the final successful request is billed from actual usage. Legacy abnormal settlements require a separately authorized reconciliation.',
      states: { started: 'In progress', failed: 'Failed', succeeded: 'Succeeded', canceled: 'Canceled' },
      billing: {
        not_billable: 'Not billable', standard_usage: 'Standard usage',
        pending_reconciliation: 'Legacy pending reconciliation', reserved: 'Legacy reserved', settled: 'Legacy abnormal settlement (refund pending)', released: 'Legacy released',
      },
    },
