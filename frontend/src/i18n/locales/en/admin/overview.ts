export default {
    ...
    users: {
      ...
      rechargeBonus: 'Bonus Amount',
      rechargeBonusHint: 'Bonus balance is credited but excluded from cumulative recharge and invite rebates',
      rechargePrincipalInvalid: 'Recharge principal must be greater than 0',
      rechargeBonusInvalid: 'Bonus amount must be greater than or equal to 0',
      rechargeBonusOperationInvalid: 'Bonus amount is only supported for recharge operations',
      rechargeIdempotencyConflict: 'This recharge request was already used with different amounts. Close the dialog and try again.',
