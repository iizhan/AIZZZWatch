export default {
  ...
  nav: {
    ...
    publicPricing: 'Published Rates',
    recommendations: 'Site Bounties',
    recommendationsReview: 'Bounty Review',
    beta: 'Beta',
    profile: 'Profile',
    users: 'Users',
    groups: 'Groups',
