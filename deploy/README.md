...
| `TOTP_ENCRYPTION_KEY` | **Recommended** | *(auto-generated)* | Fixed encryption key for TOTP and durable encrypted credentials, including Watch upstream Token/Cookie/password storage |
