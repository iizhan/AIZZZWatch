...
func RegisterUserRoutes(
	...
	authenticated.Use(gin.HandlerFunc(auditLog))
	{
		...
		user := authenticated.Group("/user")
		{
			...
			user.GET("/recommendations/models", h.Recommendation.ListModels)
			user.GET("/recommendations", h.Recommendation.ListMine)
			user.POST("/recommendations", h.Recommendation.Create)
			user.POST("/recommendations/transfer", h.Recommendation.Transfer)
			user.GET("/public-pricing", h.Recommendation.PublicPricing)
