...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	recommendationService := service.NewRecommendationService(client, billingCacheService)
