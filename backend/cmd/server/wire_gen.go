...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	watchService := service.ProvideWatchService(adminAccountRepository, groupRepository, channelRepository, watchSourceRepository, groupService, channelService, billingCacheService, watchSourceService, opsRepository)
